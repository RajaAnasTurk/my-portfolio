...
const Footer = () => {
  return (
    <div id="contact" className="pt-[4rem] md:pt-[4rem] pb-[2rem] bg-[#02050a]">
        <h1 className="heading">
        Con<span className="text-yellow-200">tact</span>
      </h1>
    <div className="pt-[8rem] pb-[1rem] bg-[#02050a]">
      <div className="grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2
        ...
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-[17px] w-[90%] text-white opacity-60">Example</p>
          </div>
        </div>
        <div className="flex items-center space-x-6">
          <div className="md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center
      ...
      <div className="w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-center">
        <div className="text-[16px] mb-[2rem] md:mb-0 text-white opacity-20">
          Raja Anas 2024 | All Rights Reserved 
        </div>
        <div className="flex items-center space-x-10">
            <p className="text-[16px] text-white opacity-20">Team & Condition</p>
